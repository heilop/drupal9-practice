...
/**
 * TranscodeProfile form.
 *
 * @property \Drupal\transcode_profile\TranscodeProfileInterface $entity
 */
class TranscodeProfileForm extends EntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $message = $result == SAVED_NEW
      ? $this->t('Created new Transcode profile %label.', $message_args)
      : $this->t('Updated Transcode profile %label.', $message_args);
